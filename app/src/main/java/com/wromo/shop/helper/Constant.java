...
public class Constant {
    ...
    public static final String MainBaseUrl = "https://web.wromo.app/"; //Admin panel url

    //set your jwt secret key here...key must same in PHP and Android
    public static final String JWT_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxNDAyMTk4NEFBWFhBVlZXIiwibmFtZSI6IlRlYW0gV3JvbW8iLCJpYXQiOjE0MDIxOTg0fQ.dBNRvfdFWtt93D91jxV9ZrITEhe487WxV1-t2d8H4zM";

    public static final int GRID_COLUMN = 3; //Category View Number Of Grid Per Line

    public static final int LOAD_ITEM_LIMIT = 40; //Load items limit in listing ,Maximum load item once
